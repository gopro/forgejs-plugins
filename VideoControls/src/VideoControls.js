...
ForgePlugins.VideoControls.prototype =
{
    ...
    boot: function()
    {
        ...
        {
            playSkin.out.image = {key: "play-out", url: this.plugin.fullUrl+"assets/button-play.png"};
        }
        else
        {
        ...
        if (FORGE.Device.ie === true)
        {
            pauseSkin.out.image = {key: "pause-out", url: this.plugin.fullUrl+"assets/button-pause.png"};
        }
        else
        {
        ...
        if (FORGE.Device.ie === true)
        {
            volume0.out.image = {key: "volume-0", url: this.plugin.fullUrl+"assets/sound-state-0.png"};
        }
        else
        {
        ...
        if (FORGE.Device.ie === true)
        {
            volume1.out.image = {key: "volume-1", url: this.plugin.fullUrl+"assets/sound-state-1.png"};
        }
        else
        {
        ...
        if (FORGE.Device.ie === true)
        {
            volume2.out.image = {key: "volume-2", url: this.plugin.fullUrl+"assets/sound-state-2.png"};
        }
        else
        {
        ...
        if (FORGE.Device.ie === true)
        {
            this._volumeCursor = this.plugin.create.image({key: "volume-cursor", url: "assets/sound-cursor.png"});
        }
        else
        {
        ...
        if (FORGE.Device.ie === true)
        {
            fsEnterSkin.out.image = {key: "fs-enter", url: this.plugin.fullUrl+"assets/button-fs-enter.png"};
        }
        else
        {
        ...
        if (FORGE.Device.ie === true)
        {
            fsExitSkin.out.image = {key: "fs-exit", url: this.plugin.fullUrl+"assets/button-fs-exit.png"};
        }
        else
        {
